---
title: Architecture
description: Layers, data model, the pacing rule, the send flow, API conventions, enforced rules.
---

This document describes how LockedIn is put together, and — more importantly — *why the pieces are
separated where they are*. The MVP scope is defined in [ROADMAP.md](/docs/engineering/roadmap); the technology
choices and their rationale are in [DECISIONS.md](/docs/engineering/decisions). This document sits between the
