...
/**
 * Token preview. Exists so the design layer can be eyeballed in both themes
 * before any real screen is built, and so a contrast regression is visible
 * rather than theoretical. Replaced when the real frontend lands.
 */
    ...
    <main className="lk-container" style={{ paddingBlock: 48 }}>
      ...
      <section>
        ...
        <p style={{ color: 'var(--ink-soft)' }}>
          Four source values in <code>src/styles/tokens.css</code>. Everything
          below is derived from them with <code>color-mix()</code>. The vivid
          green is 1.88:1 on the light background, so it is restricted to fills,
          borders and dots — never text.
        </p>
        <div
          style={{
            display: 'grid',
      ...
      <section>
        ...
        <p style={{ marginTop: 24 }}>
          A hard offset shadow, radius zero, and{' '}
          <a href="https://leetcode.com/problems/two-sum">an accent link</a> in
          running serif text.
        </p>
      </section>
    </main>
